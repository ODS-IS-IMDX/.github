...
| 2025年度| repo_infradx_ap_FDI_0080 | テーブル（TBL）出力（一時データベース（DB）→設備データ管理マスタデータベース（DB））用リポジトリ | 
| 2025年度| repo_infradx_ap_FDI_0090 | テーブル（TBL）出力（設備データ管理マスタデータベース（DB）→2D用最終断面テーブル）用リポジトリ | 
| 2025年度| repo_infradx_ap_FDI_0100 | テーブル（TBL）出力（設備データ管理マスタデータベース（DB）→3D用最終断面テーブル）用リポジトリ | 
