<img src="https://github.com/ODS-IS-IMDX/.github/blob/main/images/oelogo_mid.png" width="45%">
...
| データ標準化 | 共通仕様2Dシェープファイルを標準仕様3Dシェープファイルに変換する機能 |
...
| リポジトリ名 | リポジトリ説明 |
|----|----|
| repo_infradx_ap_PCM_0010 | 公益事業者情報削除用リポジトリ |
| repo_infradx_ap_LIM_0010 | レイヤ情報登録用リポジトリ |
| repo_infradx_ap_LIM_0020 | レイヤ情報削除用リポジトリ |
| repo_infradx_ap_FDI_0010 | データ標準化用リポジトリ |
| repo_infradx_ap_FDI_0020 | データ取込用リポジトリ |
| repo_infradx_ap_FDI_0030 | データ登録用リポジトリ |
| repo_infradx_ap_FDI_0040 | 品質チェック用リポジトリ |
| repo_infradx_ap_FDI_0050 | データ公開用リポジトリ |
| repo_infradx_ap_FDI_0060 | 履歴管理用リポジトリ |
| repo_infradx_ap_FDI_0070 | 差分管理用リポジトリ |
| repo_infradx_ap_FDI_0080 | TBL出力（一時DB→設備データ管理マスタDB）用リポジトリ |
| repo_infradx_ap_FDI_0090 | TBL出力（設備データ管理マスタDB→2D用最終断面テーブル）用リポジトリ |
| repo_infradx_ap_FDI_0100 | TBL出力（設備データ管理マスタDB→3D用最終断面テーブル）用リポジトリ |
| repo_infradx_ap_AIM_0010 | 認可情報登録リポジトリ |
| repo_infradx_ap_CIM_0010 | クライアント情報登録用リポジトリ |
| repo_infradx_ap_BSC_0010 | オンライン処理共通用リポジトリ |
| repo_infradx_ap_BSC_0020 | バッチ処理共通用リポジトリ |
| repo_infradx_ap_CMN_0010 | 認証用リポジトリ |
| repo_infradx_DDL | DDL用リポジトリ |
| repo_infradx_ap_GFV_0010 | ベクタデータ配信（可視化）用リポジトリ |
| repo_infradx_ap_provider_shp_normalizer | Shapeファイル正規化用リポジトリ |
